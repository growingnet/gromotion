...
export default function App() {
  ...
  // Keep the URL in sync with run + axis so the view is shareable.
  useEffect(() => {
      ...
      <header className="flex shrink-0 flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-sm font-semibold">
            ...
            <span className="ml-2 text-[11px] font-normal text-[var(--color-ink-2)]">
              watch your network grow
            </span>
          </h1>
          <p className="text-[11px] text-[var(--color-ink-2)]">
            Replaying a saved <strong>gromo</strong> training run, one growth step at a time
          </p>
        </div>
